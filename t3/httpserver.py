...
from t3 import httputil
from t3 import ioloop
from t3 import iostream

try:
    import fcntl
except ImportError:
    if os.name == 'nt':
        from . import win32_support as fcntl
    else:
        raise
...
class HTTPRequest(object):
    ...
    def __init__(self, method, uri, version="HTTP/1.0", headers=None,
        ...
        scheme, netloc, path, query, fragment = [_str(x) for x in urllib.parse.urlsplit(uri.encode("utf8"))]
        self.path = path
        self.query = query
