...
Each module defines its own options, e.g.,
    ...
    from t3.options import define, options
...
or parse a config file with:
    ...
    import t3.options
    t3.options.parse_config_file("/etc/server.conf")
    t3.options.parse_command_line()
...
define("logging", default="info",
       help=("Set the Python log level. If 'none', t3 won't touch the "
...
define("log_file_prefix", type=str, default=None, metavar="PATH",
       help=("Path prefix for log files. "
             "Note that if you are running multiple t3 processes, "
